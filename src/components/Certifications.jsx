  ...
  return (
    <section id="certifications" className="w-full px-[12%] py-20 scroll-mt-20 text-[#1f2937] dark:text-white font-montserrat relative">
      ...
      <div className="absolute inset-0 -z-10 opacity-20">
        <div className="absolute top-1/3 left-1/4 w-96 h-96 bg-[#10b981] rounded-full mix-blend-multiply filter blur-3xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#34d399] rounded-full mix-blend-multiply filter blur-3xl"></div>
      </div>
      ...
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 text-[#1f2937]/80 dark:text-gray-300 text-lg">
        Enlaces directos y verificables a todas mis certificaciones profesionales. Haz clic para ver más detalles.
      </p>
